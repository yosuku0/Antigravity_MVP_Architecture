...
- **router**: モデル選択とプロバイダ・スイッチ予算管理 (UnifiedRouter)
...
- `NVIDIA_API_KEY` — For NIM LLM access (Optional)
- `E2B_API_KEY` — For cloud sandbox Tier 1 (Optional)
- `OLLAMA_BASE_URL` — For local fallback models (Optional, default: http://localhost:11434)
