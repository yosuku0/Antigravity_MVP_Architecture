...
| 12 | **HITL Gate 3** (wiki promotion approval) | Prevents pollution of canonical knowledge. CLI approval only. `promote.py` requires explicit `--approved-by`. | Low — CLI prompt | **YES** | **YES** |
